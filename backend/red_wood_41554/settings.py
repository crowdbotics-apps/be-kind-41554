"""
Django settings for red_wood_41554 project.
...
ROOT_URLCONF = 'red_wood_41554.urls'
...
WSGI_APPLICATION = 'red_wood_41554.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_wood_41554 API",
    "DESCRIPTION": "API documentation for red_wood_41554 App",
    "VERSION": "v1",
}
